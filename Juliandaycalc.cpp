...
int main() {
    ...
    // establish a smaller while loop to see if user wants to continue the program
    /*cout << "Do you want to convert the number back to Gregorian Calendar date? (y/n)" << endl;
    cin >> ans;
    ...
    if(ans == 'n'){
        ...
        //If user wants to continue next set of calculations according to the Fleigel van Flandern algorithm for Julian Day Number to Gregorian Date conversion
