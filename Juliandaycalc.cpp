...
using namespace std;
// Below :
// M = months Y = years D = days MIN = minutes H = hours S = seconds JDN = Julian Day NUmber
...
int main() {
    ...
    while(run){
        ...
        cout << "The day of the first date you are looking to use for calculation" << endl;
        cin >> D;
        
        // Enter the Month user wants
        cout << "The month of the first month you are looking to use for calculation" << endl;
        cin >> M;
        
        // Enter the year user wants
        cout << "The year of the first year you are looking to use for calculation" << endl;
        cin >> Y;
        ...
        //next set of calculations according to the Fleigel van Flandern algorithm for Julian Day Number to Gregorian Date conversion
        ...
        /*/ commented out because just displays date user entered
        // was important for program construction because made sure I obtained the correct Julian Day Number
        cout << "\n The Gregorian year for the afternoon on the Julian Day : \n" << year;
        cout << "\n The Gregorian month for the afternoon on the Julian Day : \n" << mon;
        cout << "\n The Gregorian day for the afternoon on the Julian Day : \n" << day << "\n"; */
        ...
        cout << "The day of the second date you are looking to use for calculation" << endl;
        cin >> D2;
            
                // Enter the second Month user wants to use for comparison
        cout << "The month of the second date you are looking to use for calculation" << endl;
        cin >> M2;
            
                // Enter the second year user wants to use for comparison
        cout << "The year of the second year you are looking to use for calculation" << endl;
        cin >> Y2;
            
        int JDN2 = (1461 * (Y2 + 4800 + (M2 - 14)/12))/4 + (367 * (M2 - 2 - 12 * ((M2 - 14)/12)))/ 12 - (3 * ((Y2 + 4900 + (M2 - 14)/12)/100))/4 + D2 - 32075;
            
        cout << "The Julian Day for your second date in history is : " << JDN2 << endl;
        ...
        // added functionality to find amount of hours
        int bethours = betdates * 24;
        
        // added fuctionality to find amount of minutes
        int betmins = bethours * 60;
        
        // added functionality to find amount of seconds
        int betsecs = betmins * 60;
            
        cout << "Difference between these two dates is " << betdates << " days" << endl;
        
        cout << "Difference between these two dates in hours is " << bethours << " hours" << endl;
        
        cout << "Difference between these two dates in minutes is " << betmins << " minutes" << endl;
        
        cout << "Difference between these two dates in seconds is " << betsecs << " seconds" << endl;
